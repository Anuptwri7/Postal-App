...
import 'package:postal_app/Attempt/model/attempt_list_model.dart';
import 'package:postal_app/Attempt/services/attempt_list_services.dart';
import 'package:shimmer/shimmer.dart';

class AttemptListScreen extends StatefulWidget {
  const AttemptListScreen({Key? key}) : super(key: key);

  @override
  State<AttemptListScreen> createState() => _AttemptListScreenState();
}
    ...
    return Scaffold(
      ...
      body: FutureBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot snapshot) {
          ...
          if (snapshot.hasData) {
            try {
              final List<AttemptListModel> snapshotData = snapshot.data;
